...
/*! \file loader.c Loads an exe file and launches it.
    ...
    This program will search through a FAT file system on a disk and display all the exe files
    in a menu. If there is only one exe, it will load that file. If there is more than one exe
    it will wait for the user to input a number for the file that they want. The exe file will
    then be loaded in to memory and executed.
 */
