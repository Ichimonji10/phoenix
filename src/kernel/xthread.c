...
extern void create_process_asm(void (*start_routine), word *stack);
...
//stored all the register value than suspend the current thread, after the thread suspended the next runnable thread will be called.
